 ...
 const confirmRoomSelection = () => {
    ...
    <div className="container">
      <section className="a">
          ...
          <div className="outer">
            <div className="details">
              ...
              <h2>
                ...
                <span>Custodian's Contact: 0781189116</span> <br></br>
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=Frama+Hostel+Makerere+Kikoni" target="_blank" class="btn-directions">
                  Get Directions
               </a>
          </div>
        </div>
        ...
        <div className="room">
          ...
          <p className="price">Ugsh 850000 to 1120000 per semester</p>
        </div>
      ...
      <section className="k">
        <div className="x">
          ...
          <p>
            Standby generator: Frama hostel is not faced with power shortages
  ...
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“Frama Hostel is a great place to stay for students. The rooms are clean and comfortable, the staff is friendly and helpful, and the amenities are excellent.”</p>
      <p>— Jane Doe, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I have been staying at Frama Hostel for the past two years and I have never had any problems. The hostel is always clean and well-maintained, and the staff is always willing to go the extra mile to help.”</p>
...
<div class="row">
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I love staying at Frama Hostel because it feels like home away from home. The staff is like family, and the other residents are always friendly and welcoming.”</p>
      <p>— Mary Jones, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I highly recommend Frama Hostel to any student looking for a safe, comfortable, and affordable place to stay.”</p>
