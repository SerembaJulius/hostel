...
alert(`Selected Room Type: ${selectedRoomType}`);
      ...
      <section className="a">
        <div className="container1">
          <div className="outer">
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=God+Is+Able+Hostel+Makerere+Kikoni" target="_blank" class="btn-directions">
                  Get Directions
               </a>
          </div>
        </div>
  ...
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“God is able Hostel is a great place to stay for students. The rooms are clean and comfortable, the staff is friendly and helpful, and the amenities are excellent.”</p>
      <p>— Jane Doe, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I have been staying at God is able Hostel for the past two years and I have never had any problems. The hostel is always clean and well-maintained, and the staff is always willing to go the extra mile to help.”</p>
...
<div class="row">
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I love staying at God is able because it feels like home away from home. The staff is like family, and the other residents are always friendly and welcoming.”</p>
      <p>— Mary Jones, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I highly recommend God is able Hostel to any student looking for a safe, comfortable, and affordable place to stay.”</p>
