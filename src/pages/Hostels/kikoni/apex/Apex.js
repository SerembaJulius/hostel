...
const Apex = () => {
      ...
      <section className="a">
        <div className="container1">
          <div className="outer">
            <div className="details">
              <h1>APEX GIRLS HOSTEL</h1>
              <h2>
                <span>Located: Makerere Kikoni</span> <br></br>
                <span>Custodian's Contact: 07870735528</span>
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=Apex+Hostel+Makerere+Kikoni" target="_blank" class="btn-directions">
                  Get Directions
               </a>
          </div>
        </div>
       ...
       <section className="hotel-rooms">
        ...
        <div className="room">
          ...
          <p className="price">Ugsh 600000 per semester</p>
        </div>
        ...
        <div className="room">
          ...
          <p className="price">Ugsh 850000 per semester</p>
        </div>
  ...
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“Apex Hostel is a great place to stay for students. The rooms are clean and comfortable, the staff is friendly and helpful, and the amenities are excellent.”</p>
      <p>— Jane Doe, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I have been staying at Apex Hostel for the past two years and I have never had any problems. The hostel is always clean and well-maintained, and the staff is always willing to go the extra mile to help.”</p>
      <p>— Joy Eveline, Student</p>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I love staying at Apex Hostel because it feels like home away from home. The staff is like family, and the other residents are always friendly and welcoming.”</p>
      <p>— Akiiki Mariam, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I highly recommend Apex Girls Hostel to any student looking for a single sex hostel, comfortable, and affordable place to stay.”</p>
      <p>— Amanda Daisy, Student</p>
    </div>
  </div>
</div>
