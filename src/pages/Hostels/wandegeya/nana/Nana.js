...
const Nana = () => {
  ...
  return (
          ...
          <div className="outer">
            <div className="details">
              ...
              <h2>
                ...
                <span>Custodian's Contact: 0789345671</span><br></br>
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=Nana+Hostel+Makerere+Wandegeya" target="_blank" class="btn-directions">
                  Get Directions
               </a>
          </div>
        </div>
    ...
    <section className="hotel-rooms">
        ...
        <div className="room">
          ...
          <p className="price">Ugsh  2100000 per semester</p>
        </div>
  ...
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“Nana Hostel is a great place to stay for students. The rooms are clean and comfortable, the staff is friendly and helpful, and the amenities are excellent.”</p>
      <p>— Jane Doe, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
    <p>“I have been staying at Nana Hostel for the past two years and I have never had any problems. The hostel is always clean and well-maintained, and the staff is always willing to go the extra mile to help.”</p>
...
<div class="row">
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I love staying at Nana Hostel because it feels like home away from home. The staff is like family, and the other residents are always friendly and welcoming.”</p>
      <p>— Mary Jones, Student</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="testimonial-box">
      <p>“I highly recommend Nana Hostel to any student looking for a safe, comfortable, and affordable place to stay.”</p>
